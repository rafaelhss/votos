...
/***/ (function(module, exports) {
	...
	AFRAME.registerComponent('environment', {
	  ...
	  presets: {
	    'none' : {},
	    'custom': {active: true, seed: 8, skyType: 'atmosphere', skyColor: '#24b59f', horizonColor: '#eff9b7', lighting: 'distant', lightPosition: { x: -1.2, y: 0.88, z: -0.55}, fog: 0.83, flatShading: false, playArea: 0, ground: 'hills', groundYScale: 5, groundTexture: 'walkernoise', groundColor: '#937a24', groundColor2: '#987d2e', dressing: 'trees', dressingAmount: 200, dressingColor: '#888b1d', dressingScale: 1, dressingVariance: { x: 10, y: 10, z: 10}, dressingUniformScale: true, dressingOnPlayArea: 0, grid: 'none', gridColor: '#c5a543', shadow: true},
	  ...
	  update: function (oldDataNonPreset) {
	    ...
	    if (skyType == 'atmosphere') {
		  ...
		  this.setStars((1 - Math.max(0, ((-0.01) + 0.08) * 8)) * 2000 );
	    }
